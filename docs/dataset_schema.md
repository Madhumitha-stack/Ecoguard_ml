...
| **`animal_density_score`** | Integer | `[0, 100]` | Density score representing wildlife concentration, derived from waterhole proximity and road avoidance. | `78` |
...
| **`species`** | String | `["Elephant", "Rhino", "Lion", "Buffalo", "Zebra", "None Detected"]` | The primary animal species detected or tracked in proximity to the sensor logging the event. | `"Elephant"` |
